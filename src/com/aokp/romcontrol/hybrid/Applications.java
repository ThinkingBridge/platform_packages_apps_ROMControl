...
public class Applications {
    ...
    private static final String BACKUP = "/data/data/com.aokp.romcontol/files/properties.back";
    ...
    public static void backup(Context mContext) {
        Utils.execute(new String[] { "cd /data/data/com.aokp.romcontol", "mkdir files",
